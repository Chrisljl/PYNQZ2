...
set id 0
set name Conv_fadd_32ns_32ns_32_5_full_dsp
...
set id 1
set name Conv_fmul_32ns_32ns_32_4_max_dsp
...
set id 2
set name Conv_fcmp_32ns_32ns_1_1
...
set id 3
set name Conv_sdiv_19s_9ns_19_23_seq
...
set id 5
set name Conv_mul_32ns_16ns_48_3
...
set id 6
set name Conv_mul_32s_16ns_48_3
set corename simcore_mul
set op mul
set stage_num 3
set max_latency -1
...
set id 8
set name Conv_mul_mul_16ns_16ns_32_1
set corename simcore_mul
set op mul
set stage_num 1
set max_latency -1
...
set out_width 32
set exp i0*i1
set arg_lists {i0 {16 0 +} i1 {16 0 +} p {32 0 +} }
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mul] == "ap_gen_simcore_mul"} {
eval "ap_gen_simcore_mul { \
    id ${id} \
...
set id 10
set name Conv_mul_mul_16ns_16s_32_1
set corename simcore_mul
set op mul
set stage_num 1
set max_latency -1
...
set out_width 32
set exp i0*i1
set arg_lists {i0 {16 0 +} i1 {16 1 +} p {32 1 +} }
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mul] == "ap_gen_simcore_mul"} {
eval "ap_gen_simcore_mul { \
    id ${id} \
...
set id 11
set name Conv_mac_muladd_16ns_16s_48ns_48_1
...
set out_width 48
set exp i0*i1+i2
set arg_lists {i0 {16 0 +} i1 {16 1 +} m {32 1 +} i2 {48 0 +} p {48 1 +} c_reg {1} }
if {${::AESL::PGuard_simmodel_gen}} {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler Conv_AXILiteS_s_axi
}
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler Conv_gmem_m_axi
}
