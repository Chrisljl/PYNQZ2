...
set IPName      "Conv"
set Version     "1.0"
set DisplayName "Conv"
set Revision    "1808241304"
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{ 0x00 CTRL       RW   0x0 "Control signals"  {  { 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." }  { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." }  { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." }  { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." }  { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." }  { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." }  { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }  } }  { 0x04 GIER       RW   0x0 "Global Interrupt Enable Register"   {  { 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" }  { 1 30 RESERVED R 0 "Reserved.  0s on read." }  } }  { 0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register"   {  { 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." }  { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." }  { 2 30 RESERVED R 0 "Reserved.  0s on read." }  } }  { 0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register"   {  { 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" }  { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" }  { 2 30 RESERVED R 0 "Reserved.  0s on read." }  } } {0x10 CHin_V W 0x0 "Data signal of CHin_V" {{0 16 CHin_V W 0 "Bit 15 to 0 Data signal of CHin_V"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x18 Hin_V W 0x0 "Data signal of Hin_V" {{0 16 Hin_V W 0 "Bit 15 to 0 Data signal of Hin_V"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 Win_V W 0x0 "Data signal of Win_V" {{0 16 Win_V W 0 "Bit 15 to 0 Data signal of Win_V"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x28 CHout_V W 0x0 "Data signal of CHout_V" {{0 16 CHout_V W 0 "Bit 15 to 0 Data signal of CHout_V"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x30 Kx_V W 0x0 "Data signal of Kx_V" {{0 8 Kx_V W 0 "Bit 7 to 0 Data signal of Kx_V"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x38 Ky_V W 0x0 "Data signal of Ky_V" {{0 8 Ky_V W 0 "Bit 7 to 0 Data signal of Ky_V"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x40 Sx_V W 0x0 "Data signal of Sx_V" {{0 8 Sx_V W 0 "Bit 7 to 0 Data signal of Sx_V"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x48 Sy_V W 0x0 "Data signal of Sy_V" {{0 8 Sy_V W 0 "Bit 7 to 0 Data signal of Sy_V"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x50 mode_V W 0x0 "Data signal of mode_V" {{0 1 mode_V W 0 "Bit 0 to 0 Data signal of mode_V"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x58 relu_en_V W 0x0 "Data signal of relu_en_V" {{0 1 relu_en_V W 0 "Bit 0 to 0 Data signal of relu_en_V"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x60 feature_in W 0x0 "Data signal of feature_in" {{0 32 feature_in W 0 "Bit 31 to 0 Data signal of feature_in"}}} {0x68 W W 0x0 "Data signal of W" {{0 32 W W 0 "Bit 31 to 0 Data signal of W"}}} {0x70 bias W 0x0 "Data signal of bias" {{0 32 bias W 0 "Bit 31 to 0 Data signal of bias"}}} {0x78 feature_out W 0x0 "Data signal of feature_out" {{0 32 feature_out W 0 "Bit 31 to 0 Data signal of feature_out"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 10.000000 machine 64 combinational 0 latency 24 II x}
...
set enable_xo_gen 0
set kernel_files {C:/Users/Caiyujie/Desktop/gongkaike/hls/conv_core/conv_core.cpp}
if {$enable_xo_gen} {
