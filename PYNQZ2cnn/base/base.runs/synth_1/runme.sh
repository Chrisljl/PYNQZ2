...
HD_PWD='C:/Users/Caiyujie/Desktop/gongkaike/PYNQ/base/base.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source base_wrapper.tcl
