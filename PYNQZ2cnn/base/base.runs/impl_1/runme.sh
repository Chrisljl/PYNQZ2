...
HD_PWD='C:/Users/Caiyujie/Desktop/gongkaike/PYNQ/base/base.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log base_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source base_wrapper.tcl -notrace
